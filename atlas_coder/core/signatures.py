...
class BugDiagnosis(dspy.Signature):
    ...
    error_message: Optional[str] = dspy.InputField(desc="Error message if available", default="")
    context: Optional[str] = dspy.InputField(desc="Additional context about the issue", default="")
...
class CodeFix(dspy.Signature):
    ...
    explanation: str = dspy.OutputField(desc="Explanation of why these changes fix the issue")
...
class TestGeneration(dspy.Signature):
    ...
    test_code: str = dspy.OutputField(desc="Complete test code with multiple test cases")
...
class CodeGeneration(dspy.Signature):
    ...
    requirements: str = dspy.InputField(desc="Detailed requirements for the code to generate")
    language: str = dspy.InputField(desc="Programming language (Python, JavaScript, etc.)")
    style: Optional[str] = dspy.InputField(desc="Code style preferences", default="")
    
    code: str = dspy.OutputField(desc="Generated code that meets the requirements")
    structure: str = dspy.OutputField(desc="Explanation of code structure and design decisions")
    usage_example: str = dspy.OutputField(desc="Example of how to use the generated code")
...
class CodeAnalysis(dspy.Signature):
    ...
    focus: Optional[str] = dspy.InputField(desc="Analysis focus: security, performance, style, all", default="all")
    ...
    recommendations: str = dspy.OutputField(desc="Specific recommendations for improvement")
...
class RefactoringSuggestion(dspy.Signature):
    ...
    goals: str = dspy.InputField(desc="Refactoring goals: readability, performance, maintainability")
